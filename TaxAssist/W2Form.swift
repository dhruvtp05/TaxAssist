...
private var questionCard: some View {
    ...
    return VStack(alignment: .leading, spacing: 20) {
        ...
        case .text:
            ...
            TextField(question.placeholder,
                      text: answerBinding)
                .padding()
    ...
    HStack(spacing: 12) {
        ...
        Button {
            ...
            HStack {
                ...
                Text(currentQuestion == questions.count - 1
                     ? "Review Answers"
                     : "Continue")
                    .font(.headline)
...
func goToNextQuestion() {
    ...
    guard validateCurrentAnswer() else {
        return
    }
...
func saveCurrentAnswer() {
    ...
    case 0:
        w2.employeeName = answer

    case 1:
        w2.socialSecurity = answer

    case 2:
        w2.streetAddress = answer
...
func answerForQuestion(_ questionIndex: Int) -> String {
    ...
    case 0:
        return w2.employeeName

    case 1:
        return w2.socialSecurity

    case 2:
        return w2.streetAddress
...
private var reviewCard: some View {
    ...
    VStack(alignment: .leading, spacing: 20) {
        ...
        reviewRow(title: "Full Name",
                  value: w2.employeeName,
                  questionIndex: 0)

        reviewRow(title: "Social Security Number",
                  value: w2.socialSecurity,
                  questionIndex: 1)

        reviewRow(title: "Street Address",
                  value: w2.streetAddress,
                  questionIndex: 2)

        reviewRow(title: "City",
                  value: w2.city,
                  questionIndex: 3)

        reviewRow(title: "State",
                  value: w2.state,
                  questionIndex: 4)

        reviewRow(title: "ZIP Code",
                  value: w2.zipCode,
                  questionIndex: 5)
